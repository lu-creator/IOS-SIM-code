...
path = split(pathname, '\');
dirname = path{end:end};
dirnamelong = numel(dirname);
...
if color_num==1 
    % 标定文件名
      ...
      imwritestack(stack_pack1,[pathname(1:end-dirnamelong) colorname1 dirname '.tif']);
...
if color_num==2 
    ...
    % 标定文件名+位置切割
      ...
      elseif laser488==0 && laser561==1
       ...
       imwritestack(stack_pack1, [pathname(1:end-dirnamelong) colorname1 dirname '.tif']);
       imwritestack(stack_pack2, [pathname(1:end-dirnamelong) colorname2 dirname '.tif']);
    ...
    % 图像分时
     ...
     % 位置划分    
      ...
      %stack_pack3=zeros(512,512,zstack);
       ...
       imwritestack(stack_pack1, [pathname(1:end-dirnamelong) colorname1 dirname '.tif']);
       imwritestack(stack_pack2, [pathname(1:end-dirnamelong) colorname2 dirname '.tif']);
       imwritestack(stack_pack3, [pathname(1:end-dirnamelong) colorname1 dirname '.tif']);
end
